...
# Table Addr, Max Entries, ASM Ptr Locs, Reg Ptr Locs, Reg pointer locs
# with offset
_tableIDs = [
    (0xCF8985, 4096,
...
class ExpTablesModule(EbModule.EbModule):
    ...
    def __init__(self):
        ...
        self._tables = map(
            lambda x_a_b_c_d: (EbTable(x_a_b_c_d[0]),
                               x_a_b_c_d[1],
                               x_a_b_c_d[2],
                               x_a_b_c_d[3],
                               x_a_b_c_d[4]),
    ...
    def freeRanges(self):
        return map(
            lambda x_a_b_c_d1: (EbModule.toSnesAddr(x_a_b_c_d1[0]._addr),
                                EbModule.toSnesAddr(x_a_b_c_d1[0]._addr) + x_a_b_c_d1[0]._size), self._tables)
