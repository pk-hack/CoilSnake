...
class TestEbColor(CoilSnakeTestCase):
    def setup(self):
        self.setup_image()
        self.color = EbColor()
...
class TestEbPalette(CoilSnakeTestCase):
    def setup(self):
    ...
    def from_image(self):
        self.palette.from_image(self.image)
        assert_list_equal(self.palette.list(),
                          [0xff, 0xff, 0xff, 0x0c, 0x00, 0xff, 0xff, 0x00, 0x00,
