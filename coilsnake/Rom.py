...
class Rom:
    ...
    def load(self, f):
        ...
        f.close()
        self._type = self.detect_type()
        if (self._type != "Unknown" and
                'free ranges' in self._type_map[self._type]):
    ...
    def write(self, i, data):
        if isinstance(data, int):
            ...
            raise ValueError(
                "write(): data must be either a list, array, or int")
